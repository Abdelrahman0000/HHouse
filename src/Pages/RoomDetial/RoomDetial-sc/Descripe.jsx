...
export default function Descripe() {
  return (
...
<li>Maison Garnier Thiebaut terry</li>
<li>bathrobes</li>
<li>
Mamounia complimentary toiletries</li>
        </ul>
    </div>
    <div className="right">
        <ul>
...
<li>King size bed</li>
<li>Down pillows</li>
<li>Maison Porthault bed linen</li>
        </ul>

        <ul>
<h3> <span className="end-logo">+</span> <span>FACILITIES & SERVICES</span> </h3>
<li>Wi-fi</li>
<li>Flat-screen TV with international </li>
<li>channels</li>
<li>Air-conditioning</li>
<li>VIP Service, private transfer</li>
        </ul>
    </div>
</div>
